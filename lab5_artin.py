...
draw_circles(my_turtle, 100, 4)
draw_circles(my_turtle, 100, 5)
draw_circles(my_turtle, 100, 10)
draw_circles(my_turtle, 100, 19)
draw_circles(my_turtle, 100, 20)
...
draw_special(my_turtle, 100, 5, 4)
draw_special(my_turtle, 100, 5, 5)
draw_special(my_turtle, 100, 5, 10)
draw_special(my_turtle, 100, 5, 19)
draw_special(my_turtle, 100, 5, 20)
