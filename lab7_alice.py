...
result = remove_duplicates_set(input_string)
print(result)
...
result1 = gem_counting("abDFMdm", "admMQq")
result2 = gem_counting("abDFMdm", "af")
result3 = gem_counting("awCcM", "cQqW")
result4 = gem_counting("bFfL", "cQqW")
...
result1 = students_id(['002', '003', '001', '004', '012'])
result2 = students_id(['002', '003', '001', '012', '003', '001'])
...
def students_id_occurrences(ids):
    ...
    Returns:
    - dict: Dictionary with student ids as keys and their occurrences as values.
    """
    ...
    for student_id in ids:
        ...
        id_occurrences[student_id] = id_occurrences.get(student_id, 0) + 1

    return id_occurrences


result1 = students_id_occurrences(['002', '003', '001', '004', '012'])
result2 = students_id_occurrences(['002', '003', '001', '012', '003', '001'])

print(result1)  # Output: {'002': 1, '003': 1, '001': 1, '004': 1, '012': 1}
print(result2)  # Output: {'002': 1, '003': 2, '001': 2, '012': 1}
...
result1 = word_frequency("I am alive. I am happy.")
result2 = word_frequency("I do not like water. I like fruits.")

print(result1)  # Output: {'I': 2, 'am': 2, 'alive.': 1, 'happy.': 1}
print(result2)  # Output: {'I': 2, 'do': 1, 'not': 1, 'like': 2, 'water.': 1, 'fruits.': 1}
