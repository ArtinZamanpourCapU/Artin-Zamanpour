...
quotient = dividend // divisor  # Use integer division operator //
remainder = dividend % divisor   # Use modulo operator %
...
perimeter = 2 * (rectangular_width + rectangular_length)  # Calculate perimeter correctly
area = rectangular_width * rectangular_length  # Calculate area correctly
...
mark_mid = marks[0]
mark_final = marks[1]
mark_average = (mark_mid + mark_final) / 2  # Calculate the average correctly
...
if len(words[0]) > len(words[1]): 
    longer_word = words[0]  # Assign the longer word correctly
else:
    longer_word = words[1]  # Assign the longer word correctly
...
#---------------------------------------------------------
increase = 0.2
increase_percentage = increase * 100  # Multiply by 100 to convert to percentage
...
x = 2
count = 0
while count < 8:  # Change condition to count < 8
    print(x)
    x = x + 2
    count = count + 1
